					...
					while (uint32 eventId = events.ExecuteEvent())
					{
						switch(eventId)
						{
							...
							case EVENT_CHAIN:
								...
								return;
							case EVENT_SUMMON:
								me->SummonCreature(45932, aSpawnLocations[0].GetPositionX(), aSpawnLocations[0].GetPositionY(), aSpawnLocations[0].GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN);
								me->SummonCreature(45932, aSpawnLocations[1].GetPositionX(), aSpawnLocations[1].GetPositionY(), aSpawnLocations[1].GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN);
								me->SummonCreature(45932, aSpawnLocations[2].GetPositionX(), aSpawnLocations[2].GetPositionY(), aSpawnLocations[2].GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN);
								me->SummonCreature(45932, aSpawnLocations[3].GetPositionX(), aSpawnLocations[3].GetPositionY(), aSpawnLocations[3].GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN);
								me->SummonCreature(45932, aSpawnLocations[4].GetPositionX(), aSpawnLocations[4].GetPositionY(), aSpawnLocations[4].GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN);
								events.ScheduleEvent(EVENT_SUMMON, 2000);
								return;
						}
					}
